...
describe("validations", () => {
  describe("signInValidates", () => {
    ...
    it("should return invalid email error", () => {
      ...
      expect(signInValidate(values).email).toMatch(
  ...
  describe("signUpValidade", () => {
    ...
    it("should return short username error", () => {
      ...
      expect(signUpValidate(values).username).toMatch(
    ...
    it("should return invalid email error", () => {
      ...
      expect(signUpValidate(values).email).toMatch(
        `"email" must be a valid email`
      )
    })
    ...
    it("should return error if password does not match", () => {
      ...
      expect(signUpValidate(values).confirm_password).toMatch(
  ...
  describe("resetValidate()", () => {
    ...
    it("should validate confirm password when different", () => {
      ...
      expect(resetValidate(values).confirm_password).toMatch(
        `confirm password does not match with password`
      )
    })
  })
